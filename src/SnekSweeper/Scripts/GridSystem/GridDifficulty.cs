...
{
    public static readonly GridDifficulty Simple = new(0, nameof(Simple), new GridSize(16, 30), 0.1f);
    public static readonly GridDifficulty Medium = new(1, nameof(Medium), new GridSize(16, 30), 0.1f);
    public static readonly GridDifficulty Hard = new(2, nameof(Hard), new GridSize(16, 30), 0.2f);
